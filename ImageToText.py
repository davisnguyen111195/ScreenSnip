...
supportedOCRLanguages = [
    ...
    {"code": "vie", "name": "VietNamese", "local": "VietNam"},
]
...
supportedOCRScripts = [
    ...
    {"code": "script/Vietnamese", "name": "Vietnamese", "alphabet": "abcdefg", "examples": ["VietNamese", "Vietnamese", "Vietnamese"]},
]
...
class mainWindowWidget(QMainWindow):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.setWindowTitle("Image to Text (can ho tro goi 0983882847)")
